...
declare global {
  ...
  const AUTHORIZE_COMPANION_WINDOW_VITE_DEV_SERVER_URL: string;
  const AUTHORIZE_COMPANION_WINDOW_VITE_NAME: string;

  const YTMD_DISABLE_UPDATES: boolean;
  const YTMD_UPDATE_FEED_OWNER: string;
  const YTMD_UPDATE_FEED_REPOSITORY: string;
