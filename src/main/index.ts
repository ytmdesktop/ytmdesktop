...
import { Shortcuts, importV1Shortcuts } from "./modules/shortcuts";
...
const shortcutsHandler = new Shortcuts();
...
store.onDidAnyChange(async (newState, oldState) => {
  ...
  shortcutsHandler.anyShortcutChanged(newState, oldState);
});
...
const createYTMView = (): void => {
  ...
  shortcutsHandler.provide(store, memoryStore, ytmView);
  ...
  try {
    ...
    try {
      ...
      if (migrateDialog.response === 1) {
        ...
        importV1Shortcuts(v1Config, store);
