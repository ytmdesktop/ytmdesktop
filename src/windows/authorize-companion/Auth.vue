...
<template>
  <div class="container-wrapper">
    <div class="container">
      ...
      <p class="subtitle"><b>{{ appName }}</b> would like to control YouTube Music Desktop App</p>
      <p class="code-confirm">Please ensure the code below matches what <b>{{ appName }}</b> is showing</p>
      <p class="code">{{ code }}</p>
      <div class="buttons">
